...
const Dropdown = () => {
  ...
  return (
    <div className={style.container}>
      ...
      <hr />
      <form>
        <div id="Earth" onClick={handleChange}>Earth</div>
        <div id="Juptr" onClick={handleChange}>Juptr</div>
        <div id="Mars" onClick={handleChange}>Mars</div>
        <div id="Merc" onClick={handleChange}>Merc</div>
      </form>
    </div>
  );
};
